...
%-------------------------------------------------------
 % \animategraphics[height=2in]{12}{animate_}{0}{40}
\end{frame}

\begin{frame}{Embedded Animation}
\animategraphics[loop,autoplay,width=8cm]{5}{animate_}{1}{40}
\end{frame}
...
%-------------------------------------------------------
\section{Assistive Technology Research Center}
%-------------------------------------------------------
\subsection{Source files}
\begin{frame}{Assistive Technology Research Center}{NTA “Núcleo de Tecnologia Assistiva”}
%-------------------------------------------------------
\begin{itemize}
	\item<1-> The group is formed by differents departments, such as the electrical, mechanical and biomechnanical department. 
	\item<2-> Create National Assistive Tecnology aimed the power-assisted wheelchair. 
\end{itemize}
...
%\begin{frame}{Embedded Animation}
%	\animategraphics[loop,controls,width=\linewidth]{12}{gif/animation-}{0}{16}
%\end{frame}
