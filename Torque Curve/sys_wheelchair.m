...
wheelchair.l = 0.4;             % Distancia até o centro de gravidade (m)

% Mass and Inertial Moments
wheelchair.Mc = 17.70;          % Massa da cadeira sem as rodas (kg)
...
wheelchair.b  = 25;     % Constante
wheelchair.FR = 0;      % Forca resistente ao rolamento da roda traseira (N)
wheelchair.Fr = 0;      % Forca resistente ao rolamento da roda traseira (N)
